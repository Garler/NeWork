...
class NewJobFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.selectDate.setOnClickListener { dialogSelectDate() }
    ...
    private fun dialogSelectDate() {
        val dialogView =
            LayoutInflater.from(requireContext()).inflate(R.layout.dialog_select_date, null)
        val dateStart = dialogView.findViewById<TextInputEditText>(R.id.date_start_text)
        val dateFinish = dialogView.findViewById<TextInputEditText>(R.id.date_finish_text)
