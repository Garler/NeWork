...
interface OnPostInteractionListener {
    fun onLikePost(feedItem: FeedItem)
    fun onRemovePost(feedItem: FeedItem)
    fun onEditPost(feedItem: FeedItem)
    fun onCardPost(feedItem: FeedItem)
    fun onSharePost(feedItem: FeedItem)
}
